---
title: "Exploring the fiji methods on a smaller dataset."
...
rmd_file <- "experiment_1647_split01.Rmd"
...
os.chdir(base_dir)
input_file = Path(f"{base_dir}/test_data/Experiment-1647_split-01.czi").as_posix()
...
slice_measurements = slices_to_roi_measurements(output_files, ij, raw_image, imp, view_channel = 4, view_z = 2)
```
